...
class FDSCalculator:
    ...
    def aggregate_contributions_by_author(self, df: pd.DataFrame, 
        ...
        author_metrics['window_start'] = start_date.date()
        author_metrics['window_end'] = end_date.date()
        author_metrics['window_days'] = time_window_days
